...
KERNEL_FQ void m01745_mxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
  ...
  sha512_update_global_utf16le_swap (&ctx0, salt_bufs[SALT_POS].salt_buf, salt_bufs[SALT_POS].salt_len);
...
KERNEL_FQ void m01745_sxx (KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
